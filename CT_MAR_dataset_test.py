...
def load_file_names(load_dir, option):
    body_files = [splitext(file_name)[0] for file_name in listdir(load_dir)]
...
class CustomDataset(Dataset):
    def __init__(self, metal_dir: str, nometal_dir: str, scale: float = 1.0, mask_suffix: str = '', transform=None, raw: str = '', option: str = ''):
        ...
        # train 파일명 리스트 
        self.metal_ids = load_file_names(metal_dir, self.option)
        self.nometal_ids = load_file_names(nometal_dir, self.option)
