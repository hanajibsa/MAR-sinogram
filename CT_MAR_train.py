...
def train_syndiff(rank, gpu, args):
    ...
    # metal_dir = '/mnt/aix21104/jw/data/syndiff/Train/recon_img/raw'
    # nometal_dir = '/mnt/aix21104/data/CT_MAR_RAW/Train/Target/recon_img'
    # mask_dir = '/mnt/aix21104/data/CT_MAR_RAW/Train/metal_trace_mask'
    train_set = CustomDataset(metal_dir, nometal_dir, transform=transform, raw=raw, option=option)

    # metal_dir_v = '/mnt/aix21104/jw/data/syndiff/Test/recon_img/raw'
    # nometal_dir_v = '/mnt/aix21104/data/CT_MAR_RAW/Test/Target/recon_img'
    # mask_dir_v = '/mnt/aix21104/data/CT_MAR_RAW/Test/metal_trace_mask'
    # val_set = CustomDataset(metal_dir_v, nometal_dir_v, mask_dir_v, transform=transform, raw=raw, option=option)
